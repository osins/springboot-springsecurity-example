...
import com.siyuo2o.glass.db.album.tables.records.HibernateSequenceRecord;
...
public class HibernateSequence extends TableImpl<HibernateSequenceRecord> {
    ...
    private static final long serialVersionUID = -416353256;

    /**
     * The reference instance of <code>album.hibernate_sequence</code>
     */
    ...
    /**
     * Create an aliased <code>album.hibernate_sequence</code> table reference
     */
